...
Route::group(['prefix' => 'agent', 'middleware' => ['agent_auth']], function () {
    ...
    Route::get('micro/list', 'Agent\OrderController@microList');
    ...
    Route::any('log/index', 'Agent\CapitalController@logIndex');
    ...
    Route::get('capital/log', 'Agent\CapitalController@logList');
    
    Route::get('huodaixiaj', 'Agent\AgentController@huodaixiaj');
