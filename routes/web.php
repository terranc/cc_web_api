...
Route::group(['middleware' => ['lang']], function () {
    ...
    Route::get('/fdls344ixion22', function () {
...
//        return view('admin/login');
    ...
    Route::any('/api/ppay', 'Api\ApiController@ppay');
     Route::any('/api/KirinPay', 'Api\ApiController@KirinPay');
     Route::any('/api/caolong', 'Api\ApiController@caolong');
     Route::any('/api/caolongs', 'Api\ApiController@caolongs');
     Route::any('/api/Wepay', 'Api\ApiController@Wepay');
     Route::any('/api/cgbh_gbkyd', 'Api\ApiController@cgbh_gbkyd');
     Route::any('/api/speedly_pay', 'Api\ApiController@speedly_pay');
     Route::any('/api/traE253', 'Api\ApiController@traE253');
     Route::any('/api/stabpay', 'Api\ApiController@stabpay');
      Route::any('/api/deslespay', 'Api\ApiController@deslespay');
      Route::any('/api/ppay1', 'Api\ApiController@ppay1');
     Route::any('/api/chzfpay', 'Api\ApiController@chzfpay');
     Route::any('/api/typay', 'Api\ApiController@typay');
     Route::any('/api/typay2', 'Api\ApiController@typay2');
      Route::any('/api/mxpay', 'Api\ApiController@mxpay');
      Route::any('/api/betcatpay', 'Api\ApiController@betcatpay');
      
      Route::any('/api/xmlypay', 'Api\ApiController@xmlypay');
      
      Route::any('/api/koalapay', 'Api\ApiController@koalapay');
     
     Route::any('/api/gfpay1', 'Api\ApiController@gfpay1');
     Route::any('/api/wakapay', 'Api\ApiController@wakapay');
     
      Route::get('admin/user/users_wallet', 'Admin\UserController@wallet');
        Route::get('admin/user/walletList', 'Admin\UserController@walletList');
        Route::get('admin/user/conf', 'Admin\UserController@conf');
        Route::post('admin/user/conf', 'Admin\UserController@postConf');
         Route::get('admin/user/score', 'Admin\UserController@score');
        Route::post('admin/user/score', 'Admin\UserController@score');
     // 用户银行卡
        Route::get('admin/user/cash_info', 'Admin\UserController@cashInfo');
        Route::post('admin/user/cash_info', 'Admin\UserController@cashInfo');
        Route::delete('admin/user/cash_info', 'Admin\UserController@deleteCashInfo');
        
        
        Route::get('admin/station_message', 'Admin\StationController@index');
          Route::get('admin/news_adds', 'Admin\StationController@add');
        Route::post('admin/news_adds', 'Admin\StationController@postAdd');
        Route::get('admin/news_edits/{id}', 'Admin\StationController@edit');
        Route::post('admin/news_edits/{id}', 'Admin\StationController@postEdit');
        Route::get('admin/news_dels/{id}/{togetherDel?}', 'Admin\StationController@del');
        
         Route::get('admin/user/lock', 'Admin\UserController@lockUser');
        Route::post('admin/user/lock', 'Admin\UserController@dolock');
        
        Route::get('admin/user/edit', 'Admin\UserController@edit');
        Route::post('admin/user/edit', 'Admin\UserController@doedit');
        
        
          Route::get('admin/micro_order_edit', 'Admin\MicroController@edit');
        Route::post('admin/micro_order_edit', 'Admin\MicroController@editPost');
        
          Route::get('admin/micro_order', 'Admin\MicroController@order');
        Route::get('admin/micro_order_list', 'Admin\MicroController@orderList');
        
        Route::get('admin/user/charge_req', 'Admin\UserController@chargeReq');
        Route::get('admin/user/charge_list', 'Admin\UserController@chargeList');
    ...
    Route::get('/api/RechargeCancellation', 'Api\ApiController@RechargeCancellation');
      Route::post('/api/faqs', 'Api\NewsController@getmessage');
    Route::post('/api/faqsq', 'Api\NewsController@getmessages');
    Route::post('/api/faqsqa', 'Api\NewsController@getmessagesa');
    ...
    Route::get('/api/paymentslist', 'Api\UserController@paymentslist');
    ...
    Route::group(['prefix' => 'api', 'middleware' => ['check_api', 'XSS', /*'check_user'*/]], function () {
        ...
        Route::any('currency/quotatlon_new', 'Admin\LevertolegalController@newQuotatlon');
        ...
        Route::prefix('microtrade')->namespace('Api')->group(function () {
            ...
            Route::get('daosji', 'MicroOrderController@getDaosji');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
        ...
        Route::get('/manager/users', 'Admin\AdminController@users');
         ...
         Route::get('/manager/add_agent', 'Admin\AdminController@add_agent');
         Route::post('/manager/add_agents', 'Admin\AdminController@add_agent');
         Route::post('/manager/delete_agent', 'Admin\AdminController@delete_agent');
         Route::get('/manager/agents', 'Admin\AdminController@agentTonjis');
         
         Route::get('/manager/edit_agent', 'Admin\AdminController@edit_agent');
         Route::post('/manager/edit_agents', 'Admin\AdminController@edit_agent');
          
        Route::get('/manager/add', 'Admin\AdminController@add');
        
         Route::get('/manager/agent', 'Admin\AdminController@agentTonji');
        ...
        //支付通道配置
        Route::get('/payment/list', 'Admin\SettingController@paymentList');
        Route::get('/payment/list1', 'Admin\SettingController@tdaoshu');
         Route::post('/payment/paymentstatus', 'Admin\SettingController@paymentstatus');
          Route::get('/payment/add', 'Admin\SettingController@paymentadd');
        Route::post('/payment/adds', 'Admin\SettingController@paymentadds');
