...
<style>
    ...
    <script type="text/html" id="statustml">
        ...
        @{{d.status==4 ? '<span class="layui-badge status_bg_1">'+'第三方代付中'+'</span>' : '' }}
    </script>
@endsection
...
@section('scripts')
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: "/agent/capital/withdraw" //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
                    {field: 'id', title: 'ID', width:80, sort: true}
                     ,{field: 'oid', title: '第三方代付订单', width:220}
                    ,{field: 'account_number', title: '用户名', width:280}
                    ...
                    ,{field: 'status', title: '状态', minWidth:140, templet: '#statustml'}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer_show('确认提币','{{url('admin/cashb_show')}}?id='+data.id+"&dailis=2",800,600);
