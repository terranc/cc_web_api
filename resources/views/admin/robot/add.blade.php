    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="sell_user" lay-verify="required" autocomplete="off" placeholder="" class="layui-input" value="@if(!empty($result->sell_user_id)){{$result->sell_user_info}}@endif">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">买方账号</label>
            <div class="layui-input-inline">
                <input type="text" name="buy_user" lay-verify="required" autocomplete="off" placeholder="" class="layui-input" value="@if(!empty($result->buy_user_id)){{$result->buy_user_info}}@endif">
            </div>
        </div>
        <div class="layui-form-item">
