...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" href="{{URL("admin/plugins/layui/css/layui.css")}}">
    <link rel="stylesheet" href="{{URL("admin/src/css/login.css")}}">
</head>
...
<div class="kit-login">
    ...
    <div class="kit-login-wapper">
        <h2 class="kit-login-slogan">欢迎使用 <br> 中合信商 后台管理</h2>
...
<script src="{{URL("admin/plugins/polyfill.min.js")}}"></script>
