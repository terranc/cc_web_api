    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                @if($dailis == 1)
                 <!--<button class="layui-btn" lay-submit="" lay-filter="Ppay" name='method' value="Ppay">Ppay代付</button>-->
                 <button class="layui-btn" lay-submit="" lay-filter="tyPay" name='method' value="tyPay">tyPay代付</button>
                 @endif
                <!--<button class="layui-btn" lay-submit="" lay-filter="caolong" name='method' value="caolong">caolong第三方通道通过</button>-->
...
@section('scripts')
    <script>
        layui.use(['form','laydate'],function () {
            ...
            form.on('submit(tyPay)', function(data) {
                var data = data.field;
                console.log(data);
                ...
                layer.confirm('确定允许提币?', function (index) {
                    ...
                    layer.close(index);
                    $.ajax({
                        url: '{{url('admin/cashb_done')}}'+'?method=tyPay'
                        ,type: 'post'
                        ,dataType: 'json'
                        ,data : data
                        ,success: function(res) {
            ...
            form.on('submit(Ppay)', function(data) {
                var data = data.field;
                console.log(data);
                if (data.verificationcode == '') {
                    layer.msg('请填写安全验证码');
                ...
                layer.confirm('确定允许提币?', function (index) {
                    ...
                    layer.close(index);
                    $.ajax({
                        url: '{{url('admin/cashb_done')}}'+'?method=Ppay'
                        ,type: 'post'
                        ,dataType: 'json'
                        ,data : data
                        ,success: function(res) {
            ...
            form.on('submit(E253)', function(data) {
                var data = data.field;
                console.log(data);
                if (data.verificationcode == '') {
                    layer.msg('请填写安全验证码');
                ...
                layer.confirm('确定允许提币?', function (index) {
                    ...
                    layer.close(index);
                    $.ajax({
                        url: '{{url('admin/cashb_done')}}'+'?method=E253'
                        ,type: 'post'
                        ,dataType: 'json'
                        ,data : data
                        ,success: function(res) {
            ...
            form.on('submit(caolong)', function(data) {
                var data = data.field;
                console.log(data);
                if (data.verificationcode == '') {
                    layer.msg('请填写安全验证码');
                ...
                layer.confirm('确定允许提币?', function (index) {
                    ...
                    layer.close(index);
                    $.ajax({
                        url: '{{url('admin/cashb_done')}}'+'?method=caolong'
                        ,type: 'post'
                        ,dataType: 'json'
                        ,data : data
                        ,success: function(res) {
