        ...
        <form class="layui-form col-lg-5">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="type" lay-verify="required">
                        <option value=""></option>
                        <optgroup label="★★期权★★">
                            <option value="7" selected>余额</option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="radio" name="way" value="increment" title="增加"  checked>
                    <!--<input type="radio" name="way" value="tdaocz" title="通道充值">-->
                    
                    <input type="radio" name="way" value="decrement" title="减少">
                    
                    <input type="radio" name="way" value="tixians" title="提现">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <input type="hidden" name="daili" value="{{$daili}}">
