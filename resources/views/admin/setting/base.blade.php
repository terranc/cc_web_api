            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">新注册用户默认是否盈利</label>
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="submail_template" value="0" title="正常" @if (isset($setting['submail_template'])) {{$setting['submail_template'] == 0 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="submail_template" value="1" title="盈" @if (isset($setting['submail_template'])) {{$setting['submail_template'] == 1 ? 'checked' : ''}} @else checked @endif >
                                    
                                    <input type="radio" name="submail_template" value="-1" title="输" @if (isset($setting['submail_template'])) {{$setting['submail_template'] == -1 ? 'checked' : ''}} @else checked @endif >
                                </div>
                                <div class="layui-form-mid layui-word-aux">注册时验证码是否必填</div>
                            </div>
                        </div>
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-form-item">
                            <button class="layui-btn layui-btn-primary cateManage" type="button" id="payment"><i class="layui-icon layui-icon-log"></i>通道配置</button>
                        </div>
                    </div>
